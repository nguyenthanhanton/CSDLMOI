...
namespace Quan_Ly_Lich_Thuc_Hanh_Phong_May
{
    public partial class PhieuDK : Form
    {
        ...
        private void LoadDataToComboBoxes()
        {
            ...
            // Mã lớp học
            SqlDataReader readerLop = db.ExecuteReader("SELECT MaLop FROM LopHoc");
            if (readerLop != null)
            {
            ...
            // Tên môn học
            SqlDataReader readerMH = db.ExecuteReader("SELECT TenMH FROM MonHoc");
            if (readerMH != null)
            {
                while (readerMH.Read())
                {
        ...
        private void ResetForm()
        {
            ...
            phieu_cbMaGV.Text = "Chọn mã giảng viên";
            phieu_cbMaLop.Text = "Chọn mã lớp học";
        ...
        private void DangKyLichThucHanh(int soBuoi, DateTime ngay, string maLop, string tenMon, 
            int hk, string namHoc, string maGV)
        {
            try
            {
        ...
        private void phieu_btn_dky_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(maGV))
                danhSachLoi.Add("Chưa chọn mã GV.");
            if (string.IsNullOrEmpty(maLop))
                danhSachLoi.Add("Chưa chọn mã lớp.");
